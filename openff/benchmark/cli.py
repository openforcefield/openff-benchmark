...
@click.option(
    ...
    "--season",
    required=True,
    type=click.Choice(["1:1", "1:2", "1:3", "1:4"]),
...
@click.option('-s', '--season', required=True, type=click.Choice(['1:1', '1:2', '1:3', '1:4']), help="Season identifier specifying compute selections applied to molecules")
@click.argument('input-path', nargs=-1)
