...
@report.command()
@click.option(
    "--input-path", default="5-compare_forcefields", multiple=True, required=True
)
@click.option("--ref-method", default="default", required=True)
@click.option(
    "--output-directory", default="5-plots-compare-forcefields", required=True
)
...
def coverage_report(
    ...
    """
    from openff.benchmark.utils.coverage_report import (
