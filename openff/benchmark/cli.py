...
def export(fractal_uri, output_directory, dataset_name, compute_specs, sdf_only, delete_existing, processes):
    ...
    optexec.export_molecule_data(
            ...
            sdf_only=sdf_only, delete_existing=delete_existing, processes=processes)
